...
public class ProductController extends HttpServlet {
    ...
    private final String DisplayListProduct = "DisplayListProduct";
    private static final String CreateProductController = "CreateProductController";
    private static final String ProductDetailController = "ProductDetailController";
