 ...
 * @author admin
 */
@WebServlet(name = "OrderdetailListController", urlPatterns = {"/OrderdetailListController"})
public class OrderdetailListController extends HttpServlet {

    private final String HomeOrderPage = "HomeOrder.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String url = HomeOrderPage;
        try{
