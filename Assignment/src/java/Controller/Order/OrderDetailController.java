...
public class OrderDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = OrderDetailController;
        ...
        try{
            ...
            if(!ordID.isEmpty()){
                orderDetails = detailsDAO.getOrdDebyID(ordID);
                if(orderDetails != null){
                    request.setAttribute("OrdDetail", orderDetails);
                        
                }else{
                    url = OrderDetailController + "?action=Details";
                }
            }
        }catch (Exception ex) {
            log(ex.getMessage());
